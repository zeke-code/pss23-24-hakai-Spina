...
/**
 * Encapsulates the logic for handling raw keyboard input from a JavaFX Scene.
 * It updates the InputManager state and can delegate global actions to the GameManager.
 */
