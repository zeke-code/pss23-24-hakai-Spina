...
/**
 * Manages the rendering of all User Interface elements, such as menus, scores, and overlays.
 * It is separate from the game world's RenderSystem.
 */
public class UIManager {
    ...
    /**
     * Renders the appropriate UI based on the current game state.
     * This is called every frame after the world has been rendered.
     */
