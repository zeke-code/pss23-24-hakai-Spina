...
/**
 * A factory class dedicated to creating pre-configured game entities.
 * This centralizes entity creation logic, making it easier to manage and modify.
 */
public class EntityFactory {
    ...
    /**
     * Creates the player entity (the paddle).
     * The paddle is configured with all necessary components for rendering,
